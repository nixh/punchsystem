...
//立即发送邮件
function sendEmailNow(sessionid,cc, subject, html, csvStringForAttachments) {
	return dbm.use(m.getUserBySessionId(sessionid),sendemail(cc, subject, html, csvStringForAttachments));
}
...
// // var email = require('../../email');
// // s = new email();
// s.sendEmail("f39efc70-3629-11e5-a55f-9be434ab7853",
